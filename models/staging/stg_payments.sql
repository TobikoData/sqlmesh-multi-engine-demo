MODEL (
  name multi_engine_demo.stg_payments,
  cron '@daily',
  grain payment_id,
...
FROM multi_engine_demo.seed_raw_payments
...
-- sqlmesh create_test multi_engine_demo.stg_payments --query multi_engine_demo.seed_raw_payments "select * from multi_engine_demo.seed_raw_payments limit 5" 